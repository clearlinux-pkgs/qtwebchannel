...
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.2/submodules/qtwebchannel-everywhere-src-5.13.2.tar.xz
...
%prep
%setup -q -n qtwebchannel-everywhere-src-5.13.2
cd %{_builddir}/qtwebchannel-everywhere-src-5.13.2
...
%install
export SOURCE_DATE_EPOCH=1572503338
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtwebchannel
cp %{_builddir}/qtwebchannel-everywhere-src-5.13.2/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtwebchannel/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtwebchannel-everywhere-src-5.13.2/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtwebchannel/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qtwebchannel-everywhere-src-5.13.2/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtwebchannel/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtwebchannel-everywhere-src-5.13.2/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtwebchannel/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
cp %{_builddir}/qtwebchannel-everywhere-src-5.13.2/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtwebchannel/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtWebChannel/5.13.2/QtWebChannel/private/qmetaobjectpublisher_p.h
/usr/include/qt5/QtWebChannel/5.13.2/QtWebChannel/private/qqmlwebchannelattached_p.h
/usr/include/qt5/QtWebChannel/5.13.2/QtWebChannel/private/qwebchannel_p.h
/usr/include/qt5/QtWebChannel/5.13.2/QtWebChannel/private/signalhandler_p.h
/usr/include/qt5/QtWebChannel/5.13.2/QtWebChannel/private/variantargument_p.h
...
/usr/lib64/libQt5WebChannel.so.5.13
/usr/lib64/libQt5WebChannel.so.5.13.2
