...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qtwebchannel-everywhere-src-5.12.3.tar.xz
...
%prep
%setup -q -n qtwebchannel-everywhere-src-5.12.3
...
%install
export SOURCE_DATE_EPOCH=1556927500
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtWebChannel/5.12.3/QtWebChannel/private/qmetaobjectpublisher_p.h
/usr/include/qt5/QtWebChannel/5.12.3/QtWebChannel/private/qqmlwebchannelattached_p.h
/usr/include/qt5/QtWebChannel/5.12.3/QtWebChannel/private/qwebchannel_p.h
/usr/include/qt5/QtWebChannel/5.12.3/QtWebChannel/private/signalhandler_p.h
/usr/include/qt5/QtWebChannel/5.12.3/QtWebChannel/private/variantargument_p.h
...
/usr/lib64/libQt5WebChannel.so.5.12.3
